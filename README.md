...
- Hero image source: Group5_Main/frontend_GrpNo.5/public/hero.webp
...
- YOLO model file yolov8n.pt is included in Group5_Main/backend_GrpNo.5.
- Uploaded and processed files are saved under Group5_Main/backend_GrpNo.5/uploads.
